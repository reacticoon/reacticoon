...
// source: https://github.com/AndcultureCode/react-finderjs/blob/master/src/react-finder.jsx
class ReactFinder extends Component {
  constructor(props) {
    super(props)

    this._componentId = uuidv4()
  ...
  _initializeFinder() {
    if (this._finder == undefined && this.props.data != undefined) {
      ...
      this._finder = Finder(this._container, this.props.data, {
        className: this.props.className,
